...
H = eye(2); %measurement input matrix
Q = zeros(2,2); %measurement covariance matrix
Q(1,1) = pi * 1/180; %capacitive sensor has accuracy/noise of about .5 deg
Q(2,2) = 800/545 * 2*pi/60; %motor rpm feedback has noise of about 400 rpm, 545:1 gear box, 2pi/60 converstion rpm to rad/s
Q = Q*dt
P = .05*eye(2); %covariance matrix of error of initial estimate
K = P*H' * inv(H*P*H' + Q);
