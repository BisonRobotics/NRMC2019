...
namespace drive_controller
{
  ...
  public:
    ...
    void addPath(bezier_path path, bool forward_point);
    ...
    error_state getErrorStates();

    wheel_state getWheelStates();
...
//protected:
    ...
    bool getAngleAndLengthInfo(bezier_path path,
    ...
    bool cleanPath(bezier_path *path, double x, double y, double theta, bool fwd);
