...
// Use this header to dynamically load and bind v_rep.dll and its functions
// (call loadVrepLibrary and unloadVrepLibrary)
...
typedef simInt(__cdecl *ptrSimScaleObjects)(const simFloat *objectHandles, simInt objectCount, simFloat scalingFactor,
...
typedef simInt(__cdecl *ptrSimRegisterContactCallback)(simInt (*callBack)(simInt, simInt, simInt, simInt *,
                                                                          simFloat *));
...
typedef simInt(__cdecl *ptrSimGetRotationAxis)(const simFloat *matrixStart, const simFloat *matrixGoal, simFloat *axis,
                                               simFloat *angle);
typedef simInt(__cdecl *ptrSimRotateAroundAxis)(const simFloat *matrixIn, const simFloat *axis, const simFloat *axisPos,
                                                simFloat angle, simFloat *matrixOut);
...
typedef simInt(__cdecl *ptrSimSetIkGroupProperties)(simInt ikGroupHandle, simInt resolutionMethod, simInt maxIterations,
                                                    simFloat damping, void *reserved);
...
typedef simInt(__cdecl *ptrSimPersistentDataWrite)(const simChar *dataName, const simChar *dataValue, simInt dataLength,
                                                   simInt options);
...
typedef simInt(__cdecl *ptrSimScaleObject)(simInt objectHandle, simFloat xScale, simFloat yScale, simFloat zScale,
                                           simInt options);
typedef simInt(__cdecl *ptrSimSetShapeTexture)(simInt shapeHandle, simInt textureId, simInt mappingMode, simInt options,
                                               const simFloat *uvScaling, const simFloat *position,
...
typedef simInt(__cdecl *ptrSimGetDecimatedMesh)(const simFloat *inVertices, simInt inVerticesL, const simInt *inIndices,
                                                simInt inIndicesL, simFloat **verticesOut, simInt *verticesOutL,
                                                simInt **indicesOut, simInt *indicesOutL, simFloat decimationPercent,
                                                simInt reserved1, const simFloat *reserved2);
...
typedef simInt(__cdecl *ptrSimInsertPointsIntoPointCloud)(simInt pointCloudHandle, simInt options, const simFloat *pts,
                                                          simInt ptCnt, const simUChar *color, simVoid *optionalValues);
...
typedef simInt(__cdecl *ptrSimGetVisionSensorFilter)(simInt visionSensorHandle, simInt filterIndex, simInt *options,
                                                     simInt *pSizes, simUChar **bytes, simInt **ints, simFloat **floats,
                                                     simUChar **custom);
...
typedef simInt(__cdecl *ptrSimGetReferencedHandles)(simInt objectHandle, simInt **referencedHandles, simInt **reserved1,
                                                    simInt **reserved2);
...
typedef simVoid(__cdecl *ptr_simGetObjectCumulativeTransformation)(const simVoid *object, simFloat *pos, simFloat *quat,
                                                                   simBool excludeFirstJointTransformation);
...
typedef simVoid(__cdecl *ptr_simAddForceSensorCumulativeForcesAndTorques)(simVoid *forceSensor, const simFloat *force,
                                                                          const simFloat *torque, int totalPassesCount);
...
typedef simVoid(__cdecl *ptr_simGetCumulativeMeshes)(const simVoid *geomInfo, simFloat **vertices, simInt *verticesSize,
                                                     simInt **indices, simInt *indicesSize);
...
extern ptr_simSetDynamicForceSensorLocalTransformationPart2IsValid
